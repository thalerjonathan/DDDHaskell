...
public interface AccountService {
    ...
    void withdraw(String iban, double amount) throws AccountNotFoundException;
    void transfer(String sendingIban, String receivingIban, double amount, String reference) throws AccountNotFoundException, CustomerNotFoundException;
